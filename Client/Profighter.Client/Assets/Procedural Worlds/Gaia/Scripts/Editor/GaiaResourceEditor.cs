...
#pragma warning restore 162
        ...
        private static void CreateFloraTerrainDetailSettings(ResourceProtoDetail resourceProtoDetail)
        {
#if FLORA_PRESENT
            if (resourceProtoDetail.m_detailProtoype != null)
            {
                FloraUtils.CreateConfigFromPrefab(resourceProtoDetail.m_detailProtoype, resourceProtoDetail.m_floraLODs, resourceProtoDetail.m_name, SpawnerResourceType.TerrainTree);
            }
            else
            {
